...
public class RestMeetingStoryController {
	...
	public RestMeetingStoryController() {
	...
	public void profileUpload(MultipartFile file, HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		System.out.println("RestMeetingStoryController/meetingStory/json/imgUpload 실행======================");
	...
	@RequestMapping(value="/json/listMeetingStory", method=RequestMethod.POST)
	public Map<String, Object> listMeetingStory(@RequestBody Search search) throws Exception{
	...
	@RequestMapping(value="/json/likeMeetingStory/{communityNo}", method=RequestMethod.POST)
