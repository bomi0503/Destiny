...
@RestController
@RequestMapping("/love/*")
public class RestLoveController {
	...
	/*ListLoveAdvice : start*/
	@RequestMapping(value="/json/listLoveAdvice", method=RequestMethod.POST)
	public Map<String, Object> listLoveAdvice(@RequestBody Search search) throws Exception{
		System.out.println("RestLoveController / listLoveAdvice : POST 실행 ===============");
	...
	/*likeLoveAdvice : start*/
	@RequestMapping(value="/json/likeLoveAdvice/{communityNo}", method=RequestMethod.POST)
	public Map<String, Object> likeLoveAdvice(@PathVariable("communityNo") int communityNo, @ModelAttribute("likeCount") LikeCount likeCount, HttpSession session ) throws Exception{
				
		System.out.println("likeLoveAdvice() 실행================");
