...
public class RestNoticeController {
	...
	public void profileUpload(MultipartFile file, HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		System.out.println("RestNoticeController/notice/json/imgUpload 실행======================");
	...
	@RequestMapping(value="/json/listNotice", method=RequestMethod.POST)
	public Map<String, Object> listNotice(@RequestBody Search search) throws Exception{
		System.out.println("RestNoticeController / listNotice : POST 실행 ===============");
	...
	@RequestMapping(value="/json/likeNotice/{communityNo}", method=RequestMethod.POST)
	public Map<String, Object> likeNotice(@PathVariable("communityNo") int communityNo, @ModelAttribute("likeCount") LikeCount likeCount, HttpSession session ) throws Exception{
