...
<!-- All js -->
	...
	$(function(){
			 ...
			 $.ajax({
				 ...
				 success : function(JSONData, status){
					 if(JSONData.user != null){
						...
						$('#userIdWirte').text("존재하지 않은 아이디입니다.");
					 }
				 }
			 });
		 });
		...
		$('#updatePassword').on("click", function(){
			...
			var userId = $('#userId').val();
			self.location = "/user/updatePassword/"+userId;
		});
	...
	<section id="main" class="wrapper">
		<div class="inner">
			...
			<div class="row uniform">
			   <h3><strong class="text-danger">비밀번호 변경 화면입니다.</strong></h3>
			   
			   <div class="12u">
					<input type="text"  id="userId" name="userId" placeholder="아이디">
					<br/><span id="userIdWirte"></span>
				 </div>
			...
			<ul class="actions align-center">
				<li><a href="#" class="button special" id="updatePassword">확인</a></li>
			</ul>
