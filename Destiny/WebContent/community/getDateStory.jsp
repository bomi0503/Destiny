...
<script type="text/javascript">
	...
	$(function(){
		...
		$("button:contains('글쓰기')").on("click", function() {
			self.location = "/date/addDateStory"
		});
		/* 글쓰기 버튼 이벤트 : end */
		...
		$(".modify").on("click", function() {
			...
			self.location = "/date/updateDateStory?communityNo=${community.communityNo}"
		});
		/* 수정 버튼 이벤트 : end */
		...
		$(".delete").on("click", function() {
			//self.location = "/info/updateRestaurantInfo?communityNo="+${community.communityNo}
			self.location = "/date/deleteDateStory?communityNo=${community.communityNo}"
		});
		/* 수정 버튼 이벤트 : end */
		...
		/* 공감 버튼 이벤트 : start */
			...
			$.ajax({
				method : "POST",
				url : '/date/json/likeDateStory/'+communityNo,
				headers : {
		...
		$("button:contains('이전글')").on("click", function(){
			...
			self.location="/date/getPreDateStory?communityNo="+communityNo
		});
		/* 이전글 클릭 : end */
		...
		$("button:contains('다음글')").on("click", function(){
			var communityNo = $(this).data("param")
			self.location="/date/getNextDateStory?communityNo="+communityNo
		});
		/* 다음글 클릭 : end */
	});
